 ...
 */body{font-family:Lato,'Helvetica Neue',
  Helvetica,Arial,sans-serif}
    ...
    .call-to-action{position:relative;background-color:#343a40;background:url(../user/img/bg-masthead.jpg) no-repeat center center;background-size:cover;padding-top:7rem;padding-bottom:7rem}
...
header.masthead {
  ...
  /*background: url("../user/img/bg-masthead.jpg") no-repeat center center; /** =======>  IMAGEN DE PAG PRINCIPAL*/
   background: url({{url('/storage/'. $posts[0]->picturehotel )}}) no-repeat center center; /** =======>  IMAGEN DE PAG PRINCIPAL*/
  /* background: "{{ storage_path().'/app/public/'.$posts[0]->picturehotel }}" no-repeat center center; /** =======>  IMAGEN DE PAG PRINCIPAL*/
...
.call-to-action {
  ...
  /*background: url("../user/img/bg-masthead.jpg") no-repeat center center; /** =======>  IMAGENES REPETIDAS DE OTRAS PAG */
   background:url({{url('/storage/'. $posts[1]->picturehotel )}})  no-repeat center center; /** =======>  IMAGENES REPETIDAS DE OTRAS PAG */
  /*background:({{ ('/storage/'. $posts[1]->picturehotel )}})  no-repeat center center; /** =======>  IMAGENES REPETIDAS DE OTRAS PAG */
